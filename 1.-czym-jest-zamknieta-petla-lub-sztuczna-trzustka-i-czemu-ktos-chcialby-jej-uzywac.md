...
Spośród rzeczy, które musisz robić dzisiaj \(w związku z codziennym leczeniem cukrzycy, a w szczególności dozowaniem insuliny\) co chciałbyś móc odpuścić, i nie musieć już robić - gdy to było tylko możliwe? Liczenia węglowodanów? Podawania bolusów? Lub w przypadku wyników – co gdybyś mógł zapobiec spadkom glikemii po posiłku? Lub zredukować piki w górę?
